...
class StudentClass:
	def __init__(self,root):
		...
		#====TITLE======================
		title=Label(self.root,text="Manage STUDENT Details",font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=5,y=15,width=1185,height=35)
		...
		self.CourseTable=ttk.Treeview(self.C_Frame,column=("roll","name","email","gender","dob","contact","addmission","course","state","city","pin","address"),xscrollcommand=scrollx.set,yscrollcommand=scrolly.set)
