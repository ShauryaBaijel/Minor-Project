...
class ReportClass:
	def __init__(self,root):
		...
		#====TITLE====
		title=Label(self.root,text="VIEW STUDENT RESULT",font=("goudy old style",20,"bold"),bg="orange",fg="black").place(x=5,y=15,width=1185,height=50)
#=========Search===========
		...
		btn_search=Button(self.root,text="SEARCH",font=("goudy old style",15,"bold"),bg="#4d155c",fg="white",cursor="hand2",command=self.search).place(x=680,y=100,width=100,height=35)
...
#======================LABELS==============
		...
		#===========Button======
		btn_delete = Button(self.root, text="DELETE", font=("goudy old style", 15, "bold"), bg="red", fg="white",cursor="hand2",command=self.delete).place(x=525, y=350, width=150, height=35)
