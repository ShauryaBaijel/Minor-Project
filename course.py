...
class CourseClass:
	def __init__(self,root):
		...
		self.root.geometry("1200x480+80+180")
		self.root.config(bg="white")
		self.root.focus_force()
		#====TITLE====
		title=Label(self.root,text="Manage COURSE Details",font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=5,y=15,width=1185,height=35)
		#====Variables====
...
#====ENTRIES====
		...
		#====BUTTONS====
		self.btn_add=Button(self.root,text="SAVE",font=("goudy old style",20,"bold"),bg="#29f9ff",fg="black",cursor="hand2",command=self.add)
		self.btn_add.place(x=150,y=400,width=110,height=40)
		self.btn_update=Button(self.root,text="UPDATE",font=("goudy old style",15,"bold"),bg="#29bbff",fg="white",cursor="hand2",command=self.update)
		self.btn_update.place(x=270,y=400,width=110,height=40)
		self.btn_delete=Button(self.root,text="DELETE",font=("goudy old style",15,"bold"),bg="#2934ff",fg="white",cursor="hand2",command=self.delete)
		self.btn_delete.place(x=390,y=400,width=110,height=40)
		self.btn_clear=Button(self.root,text="CLEAR",font=("goudy old style",15,"bold"),bg="#9829ff",fg="white",cursor="hand2",command=self.clear)
		...
		btn_search=Button(self.root,text="SEARCH",font=("goudy old style",15,"bold"),bg="#4d155c",fg="white",cursor="hand2",command=self.search).place(x=1070,y=60,width=120,height=28)
		...
		self.CourseTable=ttk.Treeview(self.C_Frame,column=("cid","name","duration","charges","description"),xscrollcommand=scrollx.set,yscrollcommand=scrolly.set)
		...
		self.CourseTable.column("description",width=160)
			...
			if self.var_course.get() == "":
				...
				if row== None:
					...
					if op==True:
						...
						con.commit()
						messagebox.showinfo("DELETE","Corse Deleted Successfully",parent=self.root)
						self.clear()
