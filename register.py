...
class Register:
    def __init__(self,root):
        ...
        #row1=========================================
        f_name=Label(frame1,text="First Name",font=("times new roman",15,"bold"),bg="white",fg="#1e2c63").place(x=50,y=100)
        self.txt_fname=Entry(frame1,font=("times new roman",15,"bold"),bg="#c2c9ff")
        self.txt_fname.place(x=50,y=130,width=250)

        l_name=Label(frame1,text="Last Name",font=("times new roman",15,"bold"),bg="white",fg="#1e2c63").place(x=370,y=100)
        self.txt_lname=Entry(frame1,font=("times new roman",15,"bold"),bg="#c2c9ff")
        self.txt_lname.place(x=370,y=130,width=250)

        #row2=============================
        contact=Label(frame1,text="Contact No.",font=("times new roman",15,"bold"),bg="white",fg="#1e2c63").place(x=50,y=170)
        ...
        #row3======================================
        question=Label(frame1,text="Security Question",font=("times new roman",15,"bold"),bg="white",fg="#1e2c63").place(x=50,y=240)
        ...
        answer=Label(frame1,text="Answer",font=("times new roman",15,"bold"),bg="white",fg="#1e2c63").place(x=370,y=240)
        self.txt_answer=Entry(frame1,font=("times new roman",15,"bold"),bg="#c2c9ff")
        self.txt_answer.place(x=370,y=270,width=250)

        #row4=============================
        password=Label(frame1,text="Password",font=("times new roman",15,"bold"),bg="white",fg="#1e2c63").place(x=50,y=310)
        self.txt_password=Entry(frame1,font=("times new roman",15,"bold"),bg="#c2c9ff")
        self.txt_password.place(x=50,y=340,width=250)

        cpassword=Label(frame1,text="Confirm Password",font=("times new roman",15,"bold"),bg="white",fg="#1e2c63").place(x=370,y=310)
        self.txt_cpassword=Entry(frame1,font=("times new roman",15,"bold"),bg="#c2c9ff")
        self.txt_cpassword.place(x=370,y=340,width=250)

        #============TERMS============================
        self.var_chk=IntVar()
        chk=Checkbutton(frame1,text="I Agree The Terms n Conditions",variable=self.var_chk,onvalue=1,offvalue=0,bg="white",font=("times new roman",12,"bold")).place(x=50,y=380)
        ...
        btn_login=Button(self.root,text="Sign In",font=("times new roman",20,"bold"),bd=2,cursor="hand2",command=self.login_window,relief=RAISED).place(x=190,y=520,width=180)
        ...
        if self.txt_fname.get()=="" or self.txt_contact.get()=="" or self.txt_email.get()=="" or self.cmb_quest.get()=="Select" or self.txt_answer.get()=="" or self.txt_password.get()=="" or self.txt_cpassword.get()=="":
            ...
            try:
                ...
                if row!=None:
                    ...
                    con.commit()
                    con.close()
                    messagebox.showinfo("Error","Register Succeeful",parent=self.root)
                    self.clear()
                    self.login_window()
